...
describe('<Filter />', () => {
  ...
  describe('endangered filter', () => {
    ...
    it('applies filter when clicking on unchecked endangered filter', () => {
      ...
      const wrapper = shallow(
        <Filter {...commonProps} applyFilter={applyFilter} removeFilter={removeFilter} />
      );
      const filter = wrapper.find("[data-test='filter-endangered']");
      filter.simulate('click');
  ...
  describe('Sort dropdown', () => {
    ...
    const wrapper = shallow(
      <Filter {...commonProps} appliedSortId={appliedSortId} sortOptions={sortOptions} />
    );
    ...
    it('calls changeSort when clicking on menu item', () => {
      ...
      const sortOptions = [
        { id: inactiveSortId, name: 'other' },
        { id: appliedSortId, name: 'active' },
      ];
      const wrapper = shallow(
        <Filter
          {...commonProps}
          appliedSortId={appliedSortId}
