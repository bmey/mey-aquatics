...
const TermsOfUse = (): JSX.Element => (
  <Layout>
    <div className="py-14 container space-y-8">
      <Head>
        <title>Terms of Use - Mey's Aquatics</title>
      </Head>
      <h1>TERMS OF USE</h1>
      <em>Last updated March 12, 2019</em>
      <br />
      <br />
      <h2>AGREEMENT TO TERMS</h2>
      These Terms of Use constitute a legally binding agreement made between
      you, whether personally or on behalf of an entity (“you”) and Mey's
      Aquatics ("Company", “we”, “us”, or “our”), concerning your access to and
      use of the www.meysaquatics.com website as well as any other media form,
      ...
      applicable. The Site is intended for users who are at least 18 years old.
      ...
      All products are subject to availability, and we cannot guarantee that
      items will be in stock. We reserve the right to discontinue any products
      ...
      any time. All payments shall be in U.S. dollars. You agree to pay all
      charges at the prices then in effect for your purchases and any applicable
      shipping fees, and you authorize us to charge your chosen payment provider
      ...
      account, the same payment method, and/or orders that use the same billing
      or shipping address. We reserve the right to limit or prohibit orders
      ...
      so at your own risk, and you should be aware these Terms of Use no longer
      ...
      of the Site and the Marketplace Offerings.
      <h2>PRIVACY POLICY</h2>
      We care about data privacy and security. Please review our Privacy Policy:
      https://www.meysaquatics.com/privacy.html. By using the Site or the
      Marketplace Offerings, you agree to be bound by our Privacy Policy, which
      is incorporated into these Terms of Use. Please be advised the Site and
      the Marketplace Offerings are hosted in the United States. If you access
      the Site or the Marketplace Offerings from the European Union, Asia, or
      ...
      laws in the United States, then through your continued use of the Site,
      ...
      OFFERINGS (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY
      ...
      discontinuance of the Site or the Marketplace Offerings. We cannot
      ...
      suspend, discontinue, or otherwise modify the Site or the Marketplace
      Offerings at any time or for any reason without notice to you. You agree
      ...
      therewith.
      <h2>GOVERNING LAW</h2>
      These Terms of Use and your use of the Site and the Marketplace Offerings
      are governed by and construed in accordance with the laws of the State of
      Delaware applicable to agreements made and to be entirely performed within
      ...
      arbitration will take place in New Castle County, Delaware. Except as
      ...
      courts located in New Castle County, Delaware, and the Parties hereby
      ...
      ARISING OR $100.00 USD. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON
      ...
      it. USER DATA We will maintain certain data that you transmit to the Site
