...
const Privacy = (): JSX.Element => (
  <Layout>
    <div className="py-14 container space-y-8">
      <Head>
        <title>Privacy Policy - Mey's Aquatics</title>
      </Head>
      <h1>PRIVACY POLICY</h1>
      <em>Last updated March 12, 2019</em>
      <br />
      <br />
      Thank you for choosing to be part of our community at Mey's Aquatics
      ...
      <span>meysaquatics@gmail.com</span>. When you visit our website
      www.meysaquatics.com, and use our services, you trust us with your
      ...
      Sites and our services.This privacy policy applies to all information
      collected through our website (such as www.meysaquatics.com), and/or any
      related services, sales, marketing or events (we refer to them
      collectively in this privacy policy as the "Sites"). Please read this
      privacy policy carefully as it will help you make informed decisions about
      ...
      partners, and other outside sources. <br />
      <br />
      ...
      with our legal obligations, and/or your consent. <br />
      <br />
      ...
      <ul>
        <li>
          ...
          exchanges made through the Sites.
        </li>
        <li>
          <strong>To protect our Sites.</strong> We may use your information as
          part of our efforts to keep our Sites safe and secure (for example,
      ...
      your personal information for longer than 1 year. When we have no ongoing
      ...
      organizational and technical security measures. <br />
      <br />
      ...
      under age 18, please contact us at meysaquatics@gmail.com.
      ...
      California, and have a registered account with the Sites, you have the
      right to request removal of unwanted data that you publicly post on the
      Sites. To request removal of such data, please contact us using the
      ...
      Sites, but please be aware that the data may not be completely or
      ...
      meysaquatics@gmail.com or by post to: <br />
      Mey's Aquatics <br />
      P.O. Box 1501
      <br />
      Bear, DE 19701
